...
export interface SharedDropdownProps extends UseFocusTrapProps, Omit<React.AllHTMLAttributes<HTMLElement>, keyof UseFocusTrapProps>, HasRootRef<HTMLElement>, HasComponent, HasRender<HTMLElement> {
    /**
