 ...
 * @private
 */
export declare const VisuallyHiddenModalOverlay: ({ visible: visibleExcluded, position: positionExcluded, getRootRef, disableOpenAnimation, disableCloseAnimation, ...restProps }: VisuallyHiddenModalOverlayProps) => import("react").JSX.Element;
