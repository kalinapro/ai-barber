 ...
 */
export declare function useHover({ hovered, hasHover, disabled, lockState, setParentStateLock, }?: UseHoverProps): {
    isHovered: boolean;
 ...
 */
export declare function useState({ hovered, hasHover, disabled, activated, hasActive, activeEffectDelay, unlockParentHover, hoverClassName, activeClassName, }: StateProps): {
