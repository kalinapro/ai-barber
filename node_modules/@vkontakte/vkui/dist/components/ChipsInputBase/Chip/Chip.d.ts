...
import type { HasComponent, HasDataAttribute, HasRender, HTMLAttributesWithRootRef } from '../../../types';
import type { ChipOptionValue } from '../types';
export interface ChipProps extends HasComponent, HasDataAttribute, HTMLAttributesWithRootRef<HTMLElement>, HasRender<HTMLElement> {
    /**
