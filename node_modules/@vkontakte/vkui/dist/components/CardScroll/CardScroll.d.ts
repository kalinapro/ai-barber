...
export interface CardScrollProps extends HTMLAttributesWithRootRef<HTMLDivElement>, HasComponent, HasRender<HTMLDivElement>, Pick<HorizontalScrollProps, 'showArrows' | 'prevButtonTestId' | 'nextButtonTestId'> {
    /**
