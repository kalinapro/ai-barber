...
export declare const CarouselViewPort: ({ slideTestId, slideWidth, slideLabel, slideRoleDescription, onChange, onStart, onMoveX, onEnd, getRootRef, layerRef, children, setSlideRef, slidesContainerId, }: GalleryViewPortProps) => React.JSX.Element;
export {};
