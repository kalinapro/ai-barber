...
export type PlaceholderTitleProps = HTMLAttributesWithRootRef<HTMLElement> & HasComponent & HasRender<HTMLElement>;
declare const PlaceholderTitle: ({ className, ...restProps }: PlaceholderTitleProps) => React.ReactNode;
export type PlaceholderDescriptionProps = HTMLAttributesWithRootRef<HTMLElement> & HasComponent & HasRender<HTMLElement>;
