 ...
 */
export declare const ContentCard: ({ overTitle, title, titleComponent, description, caption, className, mode, style, getRootRef, getRef, maxHeight, src, srcSet, alt, width, height, crossOrigin, decoding, loading, referrerPolicy, sizes, useMap, fetchPriority, imageObjectFit, hasHover, hasActive, Component, render, ...restProps }: ContentCardProps) => React.ReactNode;
