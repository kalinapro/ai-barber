...
export declare const ImageBaseFloatElement: ({ placement, visibility, style, className, inlineIndent, blockIndent, ...restProps }: ImageBaseFloatElementProps) => React.JSX.Element;
