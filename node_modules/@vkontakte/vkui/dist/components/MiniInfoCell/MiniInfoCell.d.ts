...
export interface MiniInfoCellProps extends Pick<TappableOmitProps, 'hoverMode' | 'activeMode' | 'hovered' | 'activated' | 'hasHover' | 'hasActive'>, RootComponentProps<HTMLElement> {
    /**
     * Иконка слева.<br />
