 ...
 */
export declare const CustomScrollView: ({ enableHorizontalScroll, overscrollBehavior, scrollBehavior, scrollbarHidden, ...restProps }: CustomScrollViewProps) => React.ReactNode;
