 ...
 */
export declare const Spinner: React.MemoExoticComponent<({ size, children, disableAnimation, noColor, visibilityDelay, ...restProps }: SpinnerProps) => React.JSX.Element>;
