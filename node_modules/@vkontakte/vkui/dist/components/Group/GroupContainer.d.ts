...
export type GroupContainerProps = HTMLAttributesWithRootRef<HTMLElement> & HasComponent & HasRender<HTMLElement> & {
    /**
...
export declare const GroupContainer: ({ children, separator, mode: modeProps, padding, tabIndex: tabIndexProp, ...restProps }: GroupContainerProps) => React.JSX.Element;
