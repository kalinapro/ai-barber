...
export interface SplitLayoutProps extends HTMLAttributesWithRootRef<HTMLDivElement> {
    ...
    slotProps?: {
        ...
        content?: (React.HTMLAttributes<HTMLDivElement> & HasRootRef<HTMLDivElement> & HasDataAttribute) | undefined;
    } | undefined;
    /**
 ...
 */
export declare const SplitLayout: ({ popout, modal, header, center, reverseColumns, getRef, children, slotProps, ...restProps }: SplitLayoutProps) => React.ReactNode;
