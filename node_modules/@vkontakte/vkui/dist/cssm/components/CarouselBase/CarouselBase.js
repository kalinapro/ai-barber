...
'aria-roledescription': ariaRoleDescription = 'Карусель', arrowNextLabel = 'Следующий слайд', arrowPrevLabel = 'Предыдущий слайд', slideLabel, slideRoleDescription, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, {
        ...
        baseClassName: classNames(styles.host, slideWidth === 'custom' && styles.customWidth, isHovered && styles.hover, showArrows === 'always' && styles.showArrows, isDraggable && styles.draggable),
        getRootRef: rootRef,
        children: [
